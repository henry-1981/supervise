...
metadata:
  ...
  related-skills: "platform-database-cloud, platform-deployment, lang-typescript"
...
- platform-database-cloud: Database with auth integration
- platform-deployment: Deployment with edge authentication
- lang-typescript: TypeScript patterns for auth SDKs

...
- lang-typescript for TypeScript best practices
- lang-python for Python deployment (Railway)
- platform-auth for authentication integration
- platform-database-cloud for database patterns

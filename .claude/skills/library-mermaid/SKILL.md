...
To invoke this skill, use the standard skill invocation pattern with the skill name library-mermaid.
...
During the architecture phase, create system design diagrams to visualize proposed solutions and component relationships.

During the documentation phase, generate visual documentation including flowcharts, sequence diagrams, and architecture overviews.
...
Skills that complement this skill include library-nextra for architecture documentation sites.

Commands that utilize this skill include aria:sync for documentation with embedded diagrams and aria:plan for SPEC creation with visual architecture diagrams.

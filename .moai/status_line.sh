...
if [ -f "/Users/hb/go/bin/moai" ]; then
	exec "/Users/hb/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/hb/.local/bin/moai" ]; then
	exec "/Users/hb/.local/bin/moai" statusline < "$temp_file"
fi
